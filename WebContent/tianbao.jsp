...
<body style="background-color: #E0F0F8;">
	...
	<form class="form-horizontal" action="${pageContext.request.contextPath}/XuqiuServlet?method=zhuce&username=${adminBean.name}"
		...
		<center>
			...
			<button class="button" type="submit"  name="submit" style="font-size:20px" formaction="${pageContext.request.contextPath}/XuqiuServlet?method=baocun&username=${adminBean.name}">保存</button>
