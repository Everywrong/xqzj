...
<body>
<form action="${pageContext.request.contextPath}/UserServlet?method=updatepassword&username=${adminBean.name }&password=${adminBean.password }" method="post">
<center> 
   ...
   <a href="main.jsp" class="button button2">返回</a>
</center>
			<div>
