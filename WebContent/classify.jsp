				...
				<table class="table table-striped">
					<tr>
							...
							<c:forEach items="${demandBeans}" var="item" varStatus="status">
								<!-- var 定义变量 -->
								<tr>
									<td align="center"><a href="${pageContext.request.contextPath}/XuqiuServlet?method=ck&xuqiuname=${item.mingcheng}" style="text-decoration:none;color:black">${item.mingcheng}</a></td>
